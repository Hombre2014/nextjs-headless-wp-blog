      ...
      <div className="min-h-screen bg-[url('/home.jpg')] relative">
        ...
        <main>
          <div className='min-h-[50vh] flex flex-col items-center justify-center z-10 relative'>
            ...
            <div className='mt-20'>
              <Link href="/blog" className='text-2xl text-slate-200 border-slate-100 border-2 rounded-md py-3 px-4 hover:bg-yellow-300 hover:text-slate-800 hover:border-yellow-300 transition'>Read Blog</Link>
            </div>
          </div>
        </main>
      </div>
